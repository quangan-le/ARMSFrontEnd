...
const ApplicationUpdate = ({ applicationData, onEditSuccess, onCloseEdit }) => {
    ...
    useEffect(() => {
        if (!applicationData) {
            ...
            setFormData({
                ...
                imgDiplomaMajor2: applicationData.imgDiplomaMajor2 || "",
                ...
                typeOfDiplomaMajor2: applicationData.typeOfDiplomaMajor2 ?? null,
                typeOfTranscriptMajor2: applicationData.typeOfTranscriptMajor2 ?? null,
                ...
                academicTranscriptsMajor2: applicationData.academicTranscriptsMajor2 || [],
            });
        }
            ...
            <Form onSubmit={handleSubmit}>
                ...
                <div className="d-flex justify-content-center">
                    ...
                    <Button
                        variant="secondary"
                        onClick={onCloseEdit}
                        className="read-more-btn mt-3 ms-2"
                    >
                        Đóng
                    </Button>
                </div>
